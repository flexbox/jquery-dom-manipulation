...
function runChallenges() {
 ...
 document.getElementById("email").value ="aurelien.ducloy@outlook.fr";
  ...
  $('.table > tbody').append('<tr><td>15</td><td>UneNouvelleTeam</td><td>0</td></tr>')
  ...
  $("th").css("background-color","rgb(221,244,255");
